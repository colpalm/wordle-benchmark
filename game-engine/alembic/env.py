...
# Constants
SQL_ALCHEMY_URL_KEY = "sqlalchemy.url"
...
if (
    not config.get_main_option(SQL_ALCHEMY_URL_KEY)
    or config.get_main_option(SQL_ALCHEMY_URL_KEY) == "driver://user:pass@localhost/dbname"
):
    config.set_main_option(SQL_ALCHEMY_URL_KEY, get_database_url())
...
def run_migrations_offline() -> None:
    ...
    """
    url = config.get_main_option(SQL_ALCHEMY_URL_KEY)
    context.configure(
        url=url,
